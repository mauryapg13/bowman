...
Generated 2026-09-13T04:19:39+00:00 from `code/evaluation/usage.jsonl`, which is appended by every port call during the run that produced `output.csv` (250 requests).
...
The run that wrote `output.csv` made **190 live model calls** and **8428 cache hits** — it is fully reproducible offline. The tokens and cost below are the live calls that populated that cache (this is the compute the submission actually consumed; a handful of early calls under a superseded prompt version are included rather than hidden).
...
|---|---|---|---|---|---|
| ops/openrouter/z-ai/glm-5.3-flash | 508 | 0 | 574,291 | 179,941 | 0.1761 |

## Totals

- live model calls: **508**; final-run cache hits: **8428**
- input tokens: **574,291**; output tokens: **179,941**; total: **754,232**
- average tokens per request: **3016.9**
- estimated total cost: **$0.1761**; per request: **$0.000704**
