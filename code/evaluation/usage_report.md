...
Generated 2026-09-13T09:18:25+00:00 from `code/evaluation/usage.jsonl`, which is appended by every port call during the run that produced `output.csv` (250 requests).
...
|---|---|---|---|---|---|
| ops/openrouter/z-ai/glm-5.3-flash | 768 | 0 | 869,784 | 286,631 | 0.2738 |

## Totals

- live model calls: **768**; final-run cache hits: **209**
- input tokens: **869,784**; output tokens: **286,631**; total: **1,156,415**
- average tokens per request: **4625.7**
- estimated total cost: **$0.2738**; per request: **$0.001095**
